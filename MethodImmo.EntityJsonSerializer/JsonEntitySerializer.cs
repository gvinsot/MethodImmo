...
namespace MethodImmo.EntityJsonSerializer
{
    ...
    public sealed class JSONParameters
    {
        ...
        /// <summary>
        /// Enable MethodImmo.EntityJsonSerializer extensions $types, $type, $map (default = True)
        /// </summary>
        ...
        public Dictionary<Type, List<string>> AllowedLinks=null;
    }

    public sealed class JsonEntitySerializer
    {
        ...
        private void ProcessMap(object obj, SafeDictionary<string, JsonEntitySerializer.myPropInfo> props, Dictionary<string, object> dic)
        {
